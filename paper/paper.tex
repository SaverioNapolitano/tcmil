...
text-only single model within seed variation
(\Cref{sec:external}).
...
on 47 test subjects the difference is not resolvable. TC-MIL thus matches
...
(\Cref{sec:interpret}), which is a core requirement of our claim.
