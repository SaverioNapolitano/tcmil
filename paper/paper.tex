...
results table, which head and seed budget it uses and why, so that no number is
read against the wrong configuration.
...
official split, where every per-seed gap to a baseline is significant
(\Cref{tab:stats}), and on the $K$-Fold internal split.
...
(\Cref{tab:cv}). The per-run score distributions still overlap with the
role-aware DAMIL-R and MH (per-run std $\approx0.12$), but the matched-pair
tests resolve the means. The baselines are re-run at TC-MIL's full budget and
aligned run-for-run, so both protocols are matched at every cell: $K$-Fold at
$n=125$ paired runs (5 repeats $\times$ 5 folds $\times$ 5 seeds) and Monte
Carlo at $n=50$ (5 splits $\times$ 10 seeds). Against the three flat baselines
every metric is significant on both protocols (Wilcoxon and paired $t$,
$p<10^{-3}$; \Cref{tab:cvstats}). Against the role-aware models the picture is
protocol-dependent for the strongest baseline. Under $K$-Fold TC-MIL is
significant on all three primary metrics against \emph{every} baseline ---
DAMIL-R, MH, GSI and Conv included ($p<0.01$, almost always $p<10^{-3}$); the
only non-significant $K$-Fold cells are DAMIL-R's recall and positive-class F1
under the paired $t$. Under Monte Carlo, whose larger training splits favour the
aggregator-route DAMIL-R, that baseline closes the thresholded-metric gap
(macro-/micro-F1 differences not significant) yet TC-MIL still wins the
threshold-free ranking (ROC-AUC $p<10^{-3}$, PR-AUC $p<0.01$); against MH, GSI
and Conv the primary-metric gaps remain significant ($p<0.05$, mostly
$p<10^{-3}$). The pattern is consistent with the ladder: TC-MIL leads every
protocol \emph{headline} and wins the ranking metrics throughout, with its
...
(matched (repeat,\,fold,\,seed) runs), TC-MIL ($pos\_weight\!=\!1.0$) vs.\ each
baseline, using the Wilcoxon signed-rank test and the paired $t$-test
($p$-values; $n=125$ matched runs for $K$-Fold, $n=50$ for Monte Carlo).
``$^{*}$'' denotes $p<0.05$.}
\label{tab:cvstats}
\centering
\scriptsize
...
\multirow{8}{*}{TC-MIL vs dialogue mean}
 & UAR & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Precision & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Recall & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & pos-F1 & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & macro-F1 & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & micro-F1 & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & PR-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & ROC-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
\midrule
...
\multirow{8}{*}{TC-MIL vs DAMIL-R}
 & UAR & 0.226 & 0.369 & 0.003$^{*}$ & 0.006$^{*}$   \\
 & Precision & 0.179 & 0.542 & $<$.001$^{*}$ & 0.008$^{*}$   \\
 & Recall & 0.804 & 0.905 & 0.081 & 0.393   \\
 & pos-F1 & 0.382 & 0.921 & 0.007$^{*}$ & 0.113   \\
 & macro-F1 & 0.364 & 0.638 & 0.003$^{*}$ & 0.013$^{*}$   \\
 & micro-F1 & 0.113 & 0.143 & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & PR-AUC & 0.004$^{*}$ & 0.004$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & ROC-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
\midrule
\multirow{8}{*}{TC-MIL vs SS-DAMIL-R (MH)}
 & UAR & 0.002$^{*}$ & 0.002$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Precision & 0.002$^{*}$ & 0.005$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Recall & 0.049$^{*}$ & 0.070 & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & pos-F1 & 0.009$^{*}$ & 0.024$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & macro-F1 & 0.003$^{*}$ & 0.004$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & micro-F1 & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & PR-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & ROC-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
\midrule
\multirow{8}{*}{TC-MIL vs SS-DAMIL-R (GSI)}
 & UAR & 0.004$^{*}$ & 0.002$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Precision & 0.002$^{*}$ & 0.008$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & Recall & 0.163 & 0.108 & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & pos-F1 & 0.026$^{*}$ & 0.038$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & macro-F1 & 0.008$^{*}$ & 0.005$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & micro-F1 & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & PR-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
 & ROC-AUC & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$ & $<$.001$^{*}$   \\
\midrule
...
no test is attached. Comprehensiveness@$k$ is the probability drop when the
top-$k$ attended chunks are removed; sufficiency@$k$ is the probability drop when
...
rather than a removable shortcut. Because DAIC's prompts are semi-structured ---
the same PHQ-style questions, in the same order, for every subject --- they are
near-constant across classes and cannot by themselves discriminate the label;
they only contextualise the participant's own answers. Stripped of that context the model leans
...
source threshold is mis-calibrated under domain shift.
...
The results support a narrow but solid claim: a single TC-MIL network beats the
cleanest validity-checked baseline significantly on three F1 variants and on AUC,
and is on par (within seed variation) with the strongest reported text-only single
model on the official test split. The improvement is attributable to the
dialogue-chunk representation (the architecture ladder) and to one
calibration-level change (the class weight). The architecture ladder isolates
\emph{why}: context is the operative variable, and the instance is a more effective
and direct place to supply it than the aggregator --- the aggregator-route DAMIL-R
confirms context helps, and the ladder shows the instance route wins on both mean
and stability.

Several limitations bound the claim, beyond the wide intervals already noted.
\textbf{Sample size.} The official test set has 47 subjects (14 positive), so the
subject-level bootstrap intervals are wide and every DAIC-WOZ number, ours
included, is uncertain at the third decimal; our seed-level significance answers
``does the architecture's expected score differ'' and should not be read as a
subject-level generalisation guarantee, which the bootstrap shows is far less
resolved. \textbf{A prevalence prior, not just labels.} The a-priori prevalence
threshold is leakage-free of test \emph{labels} but assumes the deployment
prevalence equals the training prevalence ($\approx$0.28); the headline F1 (not
the threshold-free AUC) therefore depends on that prior, and a different
prevalence would move the operating point within the oracle-bounded
$[\,{\approx}0.75,0.80\,]$ band (\Cref{tab:levers}).
\textbf{Attention is not a faithful per-chunk explanation}, a property we measure
rather than assume; the faithful, informative signal lives in the occlusion
attribution, not in an attention heatmap. \textbf{Single corpus and modality.}
Model selection is on one corpus and text only; the E-DAIC result is zero-shot and
single-shot, and no audio or visual signal is used. \textbf{Label provenance.} The
binary label is itself derived from PHQ-8, the same instrument the auxiliary head
predicts, so the symptom read-out explains a PHQ-8-grounded label rather than an
independent clinical diagnosis, which DAIC-WOZ does not provide.
\iffalse
