"""SS-DAMIL-R v17: Manifold Mixup + Multi-Sample Dropout.

Reverts to the v9d backbone structure while introducing 
M-Drop (Multi-Sample Dropout) over the classification heads 
for zero-parameter ensembling. Upgrades the baseline encoder to
...
from models.ss_damil_r import SSDamilRClassifierV17
...
def main():
    parser = argparse.ArgumentParser(description="SS-DAMIL-R v17: Manifold Mixup + M-Drop")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--output_dir", type=str, default="results/ss_damil_r_cv_v17")
    ...
    parser.add_argument("--num_mc_samples", type=int, default=4)
    ...
    def train_eval_fn(train_pool, test_set, run_seed):
        ...
        for epoch in range(1, args.max_epochs + 1):
            ...
            avg_l, ml, al, dl, _ = train_epoch_v17(
    ...
    # --- Run CV ---
    logger.info("Starting Stratified Group K-Fold CV (v17 - M-Drop)...")
    ...
    with open(out_dir / "cv_report.txt", "w") as f:
        f.write(f"# SS-DAMIL-R v17 (M-Drop) CV Results\n\n{report}")
    logger.info("\n" + report)
