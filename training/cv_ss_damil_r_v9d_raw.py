"""SS-DAMIL-R v9d: Manifold Mixup (ablation).
...
def main():
    parser = argparse.ArgumentParser(description="SS-DAMIL-R v9d: Manifold Mixup")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--output_dir", type=str, default="results/ss_damil_r_cv_v9d_raw")
    ...
    # --- Data Loading ---
    logger.info("Loading all interviews with roles and symptoms from raw data...")
    all_interviews = load_all_interviews_with_roles(args.data_dir, use_raw_data=True)
    ...
    # --- Run CV ---
    logger.info("Starting Stratified Group K-Fold CV (v9d - Manifold Mixup)...")
    ...
    with open(out_dir / "cv_report.txt", "w") as f:
        f.write(f"# SS-DAMIL-R v9d (Manifold Mixup) CV Results\n\n{report}")
    logger.info("\n" + report)
