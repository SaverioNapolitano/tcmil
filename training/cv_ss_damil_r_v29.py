"""SS-DAMIL-R v29: Temporal Convolutional MIL.

Introduces a 1D Temporal Convolution layer before the Cross-Role Attention to naturally 
capture chronological context across patient utterances. Retains the highly successful 
v9d training strategies (Manifold Mixup, Dynamic MultiTask Diversity Loss, SWA) without 
introducing the overfitting risks of complex Transformer layers.
"""
...
from models.ss_damil_r import SSDamilRClassifierV29
...
def main():
    parser = argparse.ArgumentParser(description="SS-DAMIL-R v29: Temporal Convolutional MIL")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--output_dir", type=str, default="results/ss_damil_r_cv_v29")
    ...
    parser.add_argument("--conv_kernel_size", type=int, default=3, help="Kernel size for temporal conv")
    ...
    # --- Run CV ---
    logger.info("Starting Stratified Group K-Fold CV (v29 - TC-MIL)...")
    ...
    with open(out_dir / "cv_report.txt", "w") as f:
        f.write(f"# SS-DAMIL-R v29 (TC-MIL) CV Results\n\n{report}")
    logger.info("\n" + report)
