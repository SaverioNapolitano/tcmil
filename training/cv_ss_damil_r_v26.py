"""SS-DAMIL-R v26: GLU Projector + Pre-LN + bge-base-en-v1.5.

Upgrades the v9d baseline with:
  - BAAI/bge-base-en-v1.5 encoder (State-of-the-Art representation)
  - GLU Projector for adaptive feature selection
  - Pre-LayerNorm for better gradient flow
  - Retains all v9d training improvements (Manifold Mixup, SWA, etc.)
"""
...
from models.ss_damil_r import SSDamilRClassifierV26
...
def main():
    parser = argparse.ArgumentParser(description="SS-DAMIL-R v26: GLU + bge-base")
    parser.add_argument("--data_dir", type=str, default="data")
    parser.add_argument("--output_dir", type=str, default="results/ss_damil_r_cv_v26")
    ...
    # --- Run CV ---
    logger.info("Starting Stratified Group K-Fold CV (v26 - GLU + BGE Base)...")
    ...
    with open(out_dir / "cv_report.txt", "w") as f:
        f.write(f"# SS-DAMIL-R v26 (GLU + BGE Base) CV Results\n\n{report}")
    logger.info("\n" + report)
