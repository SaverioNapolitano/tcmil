"""SS-DAMIL-R v34: Tuned + Augmentation + Ensemble + Strategy 2/3/4.

Combines v33 improvements with Fold 2 Mitigation Strategies:
  - Strategy 2: Cross-Class Biased Manifold Mixup
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="results/ss_damil_r_cv_v34")
    ...
    def train_eval_fn(train_pool, test_set, run_seed):
        ...
        for epoch in range(1, args.max_epochs + 1):
            ...
            # --- Train ---
            avg_l, ml, al, dl, _ = train_epoch_v34(
            ...
            # Strategy 4: Fold-aware early stopping on val_loss
            score = v_l
            if score < best_score:
                best_score = score
                epochs_no_improve = 0
